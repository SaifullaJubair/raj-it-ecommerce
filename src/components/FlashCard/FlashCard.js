      ...
      <div className='w-[280px] '>
         <div className=" max-w-sm bg-white border border-gray-200  ">
            <div className='ml-2 mt-2'>
               <span class="bg-gray-200 text-gray-800 text-xs font-medium mr-2 px-2.5 py-1  dark:bg-gray-700 dark:text-gray-300">Dark</span>
            </div>

            <img className="p-8 " src="https://www.pngmart.com/files/7/Lift-Chair-Transparent-PNG.png" />
